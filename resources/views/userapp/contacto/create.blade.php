...
<div class="map-responsive">
    <div class="container">
        <div class="section">
            ...
            <form action="{{ url('/userapp/contacto/create') }}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group label-floating">Comentarios
                            <textarea name="comentarios" id="comentarios" class="form-control" placeholder="Escriba aquí, lo que nos quiere decir" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
